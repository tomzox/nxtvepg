...
#  Author: Tom Zoerner
#
#  $Id: mainwin.tcl,v 1.266 2011/01/05 20:03:50 tom Exp tom $
#
...
proc CreateAbout {} {
   ...
   if {$about_popup == 0} {
      ...
      label .about.copyr1 -text "Copyright (C) 1999 - 2011 by Th. \"Tom\" Zörner"
...
proc PiBox_DisplayErrorMessage {text} {
   ...
   if {[string length $text] > 0} {
      ...
      $wid insert end "\n\nCopyright (C) 1999 - 2011 by Tom Zoerner\n" bold12Tag
