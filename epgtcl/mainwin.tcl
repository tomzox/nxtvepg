...
proc CreateAbout {} {
   ...
   if {$about_popup == 0} {
      ...
      label .about.copyr1 -text "Copyright (C) 1999 - 2011, 2020 - 2023 by T. Zoerner"
...
proc PiBox_DisplayErrorMessage {text} {
   ...
   if {[string length $text] > 0} {
      ...
      $wid insert end "Grabbing and Browsing TV Programme Listings\n" bold16Tag
      $wid window create end -window ${wid}.nxtvlogo
      $wid insert end "\n\nCopyright (C) 1999 - 2011, 2020 - 2023 by T. Zoerner\n" bold12Tag
