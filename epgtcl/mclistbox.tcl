...
# TOMZO: dummy procedure to trigger module compilation
proc mclistbox_load {} {}
...
proc ::mclistbox::Init {} {
    ...
    set columnCommands [list add cget configure delete names nearest widths]
...
proc ::mclistbox::WidgetProc {w command args} {
	...
	column-widths {
	    set result {}
            upvar ::mclistbox::${w}::misc    misc
            foreach id $misc(columns) {
               lappend result [${w}.frame${id} cget -width]
            }
	}
