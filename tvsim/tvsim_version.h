 ...
 *  Author: Tom Zoerner
 *
 *  $Id: tvsim_version.h,v 1.6 2004/12/12 14:54:01 tom Exp tom $
 */
...
#define TVSIM_VERSION_MAJOR   2   // major revision
#define TVSIM_VERSION_MINOR   1   // minor revision

#define TVSIM_VERSION_STR     "2.1"


// RCS id to be included to the object code for ident(1)
#define TVSIM_VERSION_RCS_ID  "$Id: tvsim_version.h,v 1.6 2004/12/12 14:54:01 tom Exp tom $" "$Compiledate: " __DATE__ " " __TIME__" $";
