...
#  Author: Tom Zoerner
#
# $Id: tvsim.pod,v 1.1 2002/05/05 20:29:29 tom Exp tom $
# ---------------------------------------------------------------------------
...
and I<TV app. interaction> dialogs.
...
Configuration file where all configuration settings are stored. By default
...
Please refer to the B<nxtvepg> manual for information on TV card
and TV application interaction configuration.
...
Thanks to I<e-nek> for his contributions to the design of the
communication protocol, alpha testing and most importantly for
being the first to implement EPG interaction in a TV application.
