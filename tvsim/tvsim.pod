...
#  Author: Tom Zoerner
#
# $Id: tvsim.pod,v 1.9 2004/03/23 15:59:54 tom Exp tom $
# ---------------------------------------------------------------------------
...
In the current version two protocols are supported: On UNIX an X11 atoms
based protocol which allows interaction with I<xawtv> and I<xawdecode>.
...
Copyright (C) 2002,2004 by T. Zoerner.
All rights reserved.
