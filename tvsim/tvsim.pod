...
#  Author: Tom Zoerner
#
# $Id: tvsim.pod,v 1.4 2002/10/13 14:05:41 tom Exp tom $
# ---------------------------------------------------------------------------
...
Default: index 0, i.e. the "best" card in the order Bt878,
Bt878A, Bt848, Bt849.  If you have more than one TV card
with the same chip, the order between those is undefined
(i.e. depends on the driver, not tvsim or nxtvepg).
