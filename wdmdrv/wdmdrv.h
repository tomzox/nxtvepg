...
//
typedef BOOL (__stdcall *LPFN_CALLBACK)(BYTE *WSTPacket, int FrameType, LONGLONG dwLine);
...
typedef struct
{
   ...
   //
   HRESULT (WINAPI *EnumDevices)( void );
   ...
   //   WDM_DRV_UNINITIALIZED if driver not yet initialized or no device currently selected.
   //   WDM_DRV_SYSTEMERR in other cases.
   HRESULT (WINAPI *GetSignalStatus)( void );
