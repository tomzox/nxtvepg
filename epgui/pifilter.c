...
{  
   ...
   static_assert(EPGTCL_PI_FEATURE_FMT_WIDE == PI_FEATURE_FMT_WIDE, "");
   static_assert(EPGTCL_PI_FEATURE_VIDEO_NONE == PI_FEATURE_VIDEO_NONE, "");
   static_assert(EPGTCL_PI_FEATURE_VIDEO_HD == PI_FEATURE_VIDEO_HD, "");
   static_assert(EPGTCL_PI_FEATURE_VIDEO_BW == PI_FEATURE_VIDEO_BW, "");
   static_assert(EPGTCL_PI_FEATURE_REPEAT == PI_FEATURE_REPEAT, "");
   static_assert(EPGTCL_PI_FEATURE_LAST_REP == PI_FEATURE_LAST_REP, "");
   static_assert(EPGTCL_PI_FEATURE_PREMIERE == PI_FEATURE_PREMIERE, "");
   static_assert(EPGTCL_PI_FEATURE_NEW == PI_FEATURE_NEW, "");
   static_assert(EPGTCL_PI_FEATURE_SUBTITLE_MASK == PI_FEATURE_SUBTITLE_MASK, "");
   static_assert(EPGTCL_PI_FEATURE_SUBTITLE_NONE == PI_FEATURE_SUBTITLE_NONE, "");
   static_assert(EPGTCL_PI_FEATURE_SUBTITLE_TTX == PI_FEATURE_SUBTITLE_TTX, "");
   static_assert(EPGTCL_PI_FEATURE_SUBTITLE_OSC == PI_FEATURE_SUBTITLE_OSC, "");
   static_assert(EPGTCL_PI_FEATURE_SUBTITLE_SIGN == PI_FEATURE_SUBTITLE_SIGN, "");
   static_assert(EPGTCL_PI_FEATURE_SUBTITLE_ANY == PI_FEATURE_SUBTITLE_ANY, "");
   static_assert(EPGTCL_PI_FEATURE_SOUND_MASK == PI_FEATURE_SOUND_MASK, "");
   static_assert(EPGTCL_PI_FEATURE_SOUND_UNKNOWN == PI_FEATURE_SOUND_UNKNOWN, "");
   static_assert(EPGTCL_PI_FEATURE_SOUND_NONE == PI_FEATURE_SOUND_NONE, "");
   static_assert(EPGTCL_PI_FEATURE_SOUND_MONO == PI_FEATURE_SOUND_MONO, "");
   static_assert(EPGTCL_PI_FEATURE_SOUND_STEREO == PI_FEATURE_SOUND_STEREO, "");
   static_assert(EPGTCL_PI_FEATURE_SOUND_2CHAN == PI_FEATURE_SOUND_2CHAN, "");
   static_assert(EPGTCL_PI_FEATURE_SOUND_SURROUND == PI_FEATURE_SOUND_SURROUND, "");
   static_assert(EPGTCL_PI_FEATURE_SOUND_DOLBY == PI_FEATURE_SOUND_DOLBY, "");
