...
Falls die Datenbank vom Teletext EPG Grabber aktualisiert wird, wird ein zusätzlicher Bereich unterhalb den Statistiken eingeblendet, in dem ein Histogramm und Statusinformationen zur Akquisition dargestellt sind.
...
Gibt an, wie lange der Teletext vom aktuell eingestellten TV-Sender ampfangen wurde.
