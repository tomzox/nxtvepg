...
Windows-Anwender müssen zuerst den Treiber für ihre TV-Karte im Dialog "TV card input" vom Configure-Menü aus konfigurieren (weitere Informationen siehe auch L<"CONFIGURATION">, Kapitel "TV card input"). Seit Version 3.0 unerstützt nxtveog nur noch WDM Treiber.
...
Falls Sie gar keinen funktionierenden Treiber finden, können Sie als letzte Option nxtvepg parallel zur TV-Applikation "K!TV" laufen lassen. In dem Fall übernimmt die TV-Applikation die Teletext-Akquisition ohne so dass nxtvepg gar nicht auf die TV-Karte zugreifen muß.
