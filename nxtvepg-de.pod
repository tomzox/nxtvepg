...
Diese Option kann schon ausgeählt werden wenn der Teletext Grabber noch keine Daten geladen hat. In dem Fall wird nur das nxtvepg Logo und ein entsprechender Hinweis angezeigt. Sobald Daten von einem Sender geladen wurden, werden diese automatisch angezeigt. Während der Wartezeit können Sie den Fortschritt über die im Control Menü verfügbaren "Statistik" Fenster verfolgen.
...
Um die vom Grabber gesammelten Daten anzuzeigen, wählen Sie am einfachsten den "Load Teletext EPG" Eintrag im "Control" Menü. Alternative können Sie die vom Grabber erzeugten XMLTV Dateien manuell oder automatisch über den "Merge" Dialog im selben Menü einbinden.
