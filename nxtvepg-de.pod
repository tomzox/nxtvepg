...
#
# $Id: nxtvepg-de.pod,v 1.18 2008/10/03 21:02:17 tom Exp tom $
# ---------------------------------------------------------------------------
...
Vielen Dank
an Néo für die Bereitstellung der setup.exe für Windows Releases
und die französische Übersetzung der Web-Seiten;
...
Copyright (C) 1999 - 2008 by Th. Zörner. Alle Rechte vorbehalten.
