...
#  Author: Tom Zoerner
#
# $Id: nxtvepg.pod,v 1.136 2009/09/30 10:00:00 tom Exp tom $
# ---------------------------------------------------------------------------
...
=item I<NETCNI=id_code>

This command will only list programmes with the given numerical VPS or PDC
channel identification code (e.g. C<NETCNI=0xDC1> for the German "ARD".)
Multiple CNIs can be given when separated by commas.
...
This command will only list programmes labeled with the given "sorting
criterion" code. These codes are explained in L<"FILTERING">.
...
provider network name.) See also L<"CONTROL: Export as XMLTV">.
