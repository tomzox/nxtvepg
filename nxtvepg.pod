...
#  Author: Tom Zoerner
#
# $Id: nxtvepg.pod,v 1.74 2002/08/24 14:15:08 tom Exp tom $
# ---------------------------------------------------------------------------
...
Also note that the I<Network> column in the main window is automatically
resized to hold the longest name.  When determining the maximum length
all networks of the current provider are considered including those you
have suppressed in the L<"CONFIGURATION:Select networks"> dialog (because
they still might get displayed, e.g. via the L<"NAVIGATE"> menu).
