...
#  Author: Tom Zoerner
#
# $Id: nxtvepg.pod,v 1.109 2004/04/02 17:27:19 tom Exp tom $
# ---------------------------------------------------------------------------
...
to external applications (see L<"CONFIGURATION: Context menu extensions">)
...
possible placeholders enclosed in ${} which are replaced by attributes of the
currently selected programme in the browser listbox.
...
could for example result in
  ...
  plan '22.08.2001 13:05' 'Kaept'\''n Blaubaers Seemannsgarn'
...
Many thanks to Thierry Menetrier and Peter Rolf
