...
#  Author: Tom Zoerner
#
# $Id: nxtvepg.pod,v 1.58 2002/02/25 20:17:42 tom Exp tom $
# ---------------------------------------------------------------------------
...
stored in that directory. For more details see the I<Client/Server> dialog
described in L<"CONFIGURATION">.
...
if you enable them in the I<Column selection> dialog (see L<"CONFIGURATION">).
...
I<Client/Server> menu (see L<"CONFIGURATION">). By default the daemon
...
Many thanks to Jan Schuster for beta testing starting with 0.7.0;
