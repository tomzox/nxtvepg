 ...
 *  Author: Tom Zoerner
 *
 *  $Id: epgversion.h,v 1.50 2003/07/01 19:25:06 tom Exp tom $
 */
...
#define EPG_VERSION_RCS_ID  "$Id: epgversion.h,v 1.50 2003/07/01 19:25:06 tom Exp tom $" "$Compiledate: " __DATE__ " " __TIME__" $";
