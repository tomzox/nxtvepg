 ...
 *  Author: Tom Zoerner
 *
 *  $Id: epgversion.h,v 1.29 2002/12/01 12:48:41 tom Exp tom $
 */
...
#define EPG_VERSION_RCS_ID  "$Id: epgversion.h,v 1.29 2002/12/01 12:48:41 tom Exp tom $" "$Compiledate: " __DATE__ " " __TIME__" $";
