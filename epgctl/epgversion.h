 ...
 *  Author: Tom Zoerner
 *
 *  $Id: epgversion.h,v 1.28 2002/11/19 18:59:32 tom Exp tom $
 */
...
#define EPG_VERSION_RCS_ID  "$Id: epgversion.h,v 1.28 2002/11/19 18:59:32 tom Exp tom $" "$Compiledate: " __DATE__ " " __TIME__" $";
