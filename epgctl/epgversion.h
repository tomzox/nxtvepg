 ...
 *  Author: Tom Zoerner
 *
 *  $Id: epgversion.h,v 1.26 2002/09/17 15:06:50 tom Exp tom $
 */
...
#define EPG_VERSION_RCS_ID  "$Id: epgversion.h,v 1.26 2002/09/17 15:06:50 tom Exp tom $" "$Compiledate: " __DATE__ " " __TIME__" $";
