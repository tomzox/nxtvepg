 ...
 *  Author: Tom Zoerner
 *
 *  $Id: epgversion.h,v 1.51 2003/10/11 06:34:53 tom Exp tom $
 */
...
#define EPG_VERSION_RCS_ID  "$Id: epgversion.h,v 1.51 2003/10/11 06:34:53 tom Exp $" "$Compiledate: " __DATE__ " " __TIME__" $";
