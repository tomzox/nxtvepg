 ...
 *  Author: Tom Zoerner
 *
 *  $Id: epgversion.h,v 1.25 2002/08/24 14:18:22 tom Exp tom $
 */
...
#define EPG_VERSION_RCS_ID  "$Id: epgversion.h,v 1.25 2002/08/24 14:18:22 tom Exp tom $" "$Compiledate: " __DATE__ " " __TIME__" $";
