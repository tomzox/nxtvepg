 ...
 *  Author: Tom Zoerner
 *
 *  $Id: epgversion.h,v 1.14 2001/08/25 12:52:12 tom Exp tom $
 */
...
#ifndef WIN32
#define EPG_VERSION_STR     "0.6.0"
#else
#define EPG_VERSION_STR     "1.9-win"
#endif


// RCS id to be included to the object code for ident(1)
#define EPG_VERSION_RCS_ID  "$Id: epgversion.h,v 1.14 2001/08/25 12:52:12 tom Exp tom $" "$Compiledate: " __DATE__ " " __TIME__" $";
